          ...
          <div className="relative">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 md:gap-12 relative z-10">
              {[
                ...
                >
                  <div className="w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center text-xl md:text-2xl font-black shadow-lg text-white shrink-0" style={{ background: 'var(--accent-primary)', boxShadow: '0 0 30px var(--accent-glow)' }}>
                    {step.step}
                  </div>
      ...
      <section className="py-16 md:py-32 bg-section-alt relative">
        <div className="container-responsive">
          ...
          <Carousel className="w-full max-w-5xl mx-auto">
            <CarouselContent>
              {[
                { stars: 5, text: "Adz Pro transformed our e-commerce ROAS from 1.2x to 4.1x in just 60 days. Exceptional team!", author: "Rahul M.", role: "Founder, D2C Fashion" },
                { stars: 5, text: "Their brand strategy gave us a completely new identity. Our lead cost dropped by 62%.", author: "Priya S.", role: "Marketing Head, EdTech" },
                { stars: 5, text: "Within 3 months, our organic reach grew 5x. Best agency decision we ever made.", author: "Amit K.", role: "CEO, Real Estate" }
              ].map((t, i) => (
                <CarouselItem key={i}>
                  <div className="p-2 md:p-4">
                    <div className="p-8 md:p-16 rounded-[32px] md:rounded-[48px] space-y-6 md:space-y-10 relative overflow-hidden glassmorphism bg-surface/80 border-border">
                      ...
                      <p className="text-xl md:text-3xl font-black italic text-text-primary leading-tight">
                        "{t.text}"
                      </p>
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-accent-primary flex items-center justify-center text-white text-xl font-black">
                          {t.author[0]}
                        </div>
                        <div>
                          <p className="font-black text-text-primary text-base md:text-xl">{t.author}</p>
                          <p className="text-xs md:text-sm font-bold text-accent-primary uppercase tracking-widest">{t.role}</p>
                        </div>
                      </div>
                    </div>
                  </div>
